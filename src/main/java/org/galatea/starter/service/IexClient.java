...
public interface IexClient {
   ...
   */
  String token = "pk_7e7c85a0ac044c0a87110d9cdde1716e";
  ...
  List<IexHistoricalPrices> getHistoricalPricesForSymbols(@RequestParam("symbol") String symbol, @RequestParam("range") String range, @RequestParam("date") String date);
